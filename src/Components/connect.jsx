const Connect = () => {
  return (
    <>
      <div className="relative mx-auto flex h-fit w-11/12 flex-col items-center justify-around space-y-10 overflow-clip rounded-xl border-2 border-white/10 sm:h-[500px] sm:w-4/6 sm:justify-center sm:gap-y-6 sm:space-y-0">
